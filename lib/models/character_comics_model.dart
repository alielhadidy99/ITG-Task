class CharacterComicsModel {
  ...
  factory CharacterComicsModel.fromJson(Map<String, dynamic> json) =>
      CharacterComicsModel(
        code: json["code"],
        status: json["status"],
...
class Data {
  ...
  int? total;
  int? count;
  List<CharacterComicsResult>? results;
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        total: json["total"],
        count: json["count"],
        results: List<CharacterComicsResult>.from(
            json["results"].map((x) => CharacterComicsResult.fromJson(x))),
      );
...
class CharacterComicsResult {
  CharacterComicsResult({
    this.id,
    this.digitalId,
    this.title,
    this.issueNumber,
  ...
  factory CharacterComicsResult.fromJson(Map<String, dynamic> json) =>
      CharacterComicsResult(
        id: json["id"],
